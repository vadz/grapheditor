...
WXDLLIMPEXP_OGL void oglCentreText(wxReadOnlyDC& dc, wxList *text, double m_xpos, double m_ypos,
...
WXDLLIMPEXP_OGL wxStringList* oglFormatText(wxReadOnlyDC& dc, const wxString& text, double width, double height, int formatMode = 0);

// Centres the list of wxShapeTextLine strings, doesn't clip.
// Doesn't actually draw into the DC.
WXDLLIMPEXP_OGL void oglCentreTextNoClipping(wxReadOnlyDC& dc, wxList *text_list,
...
WXDLLIMPEXP_OGL void oglGetCentredTextExtent(wxReadOnlyDC& dc, wxList *text_list,
                              double m_xpos, double m_ypos, double width, double height,
